<?php
/**
 * OfferControllerTest.php - Main Controller Test Class
 *
 * Test Class for Main Controller of Offer Module
 *
 * @category Test
 * @package Offer
...
namespace OnePlaceTest\Offer\Controller;

use Digitag\Offer\Controller\OfferController;
...
class OfferControllerTest extends AbstractHttpControllerTestCase {
    ...
    public function testIndexActionCanBeAccessed() {
        ...
        $this->dispatch('/offer', 'GET');
        $this->assertResponseStatusCode(200);
        $this->assertModuleName('offer');
        $this->assertControllerName(OfferController::class); // as specified in router's controller name alias
        $this->assertControllerClass('OfferController');
        $this->assertMatchedRouteName('offer');
    }
    ...
    public function testEditActionCanBeAccessed() {
        ...
        $this->dispatch('/offer/edit/1', 'GET');
        $this->assertResponseStatusCode(200);
        $this->assertModuleName('offer');
        $this->assertControllerName(OfferController::class); // as specified in router's controller name alias
        $this->assertControllerClass('OfferController');
    ...
    public function testViewActionCanBeAccessed() {
        ...
        $this->dispatch('/offer/view/1', 'GET');
        $this->assertResponseStatusCode(200);
        $this->assertModuleName('offer');
        $this->assertControllerName(OfferController::class); // as specified in router's controller name alias
        $this->assertControllerClass('OfferController');
