...
use Digitag\Offer\Controller\ApiController;
...
class ApiControllerTest extends AbstractHttpControllerTestCase {
    ...
    public function testIndexActionCanBeAccessed() {
        ...
        $this->dispatch('/offer/api?authkey=DEVRANDOMKEY', 'GET');
        ...
        $this->assertMatchedRouteName('offer-api');
    }
}
